...
Blockly.Blocks.defaultToolbox = '<xml id="toolbox-categories" style="display: none">'+
  ...
  '<category name="Operators" id="operators" colour="#40BF4A" secondaryColour="#389438">'+
    ...
    '</block>'+
  '</category>'+
  '<category name="数据" id="data" colour="#FF8C1A" secondaryColour="#DB6E00" custom="VARIABLE">' +
  '</category>' +
  '<category name="更多" id="more" colour="#FF6680" secondaryColour="#FF4D6A" custom="PROCEDURE">' +
  '</category>' +
  '<category name="扩展" id="extensions" colour="#FF6680" secondaryColour="#FF4D6A" '+
